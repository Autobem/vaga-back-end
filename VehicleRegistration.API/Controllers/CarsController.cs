...
namespace VehicleRegistration.Presentation.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        // POST api/values
        [HttpPost]
        public ActionResult Post([FromBody] CarDTO carDTO)
        {
            try
            {
                if (carDTO == null)
                ...
                _applicationServiceCar.Add(carDTO);
        ...
        // PUT api/values/5
        [HttpPut]
        public ActionResult Put([FromBody] CarDTO carDTO)
        {
            try
            {
                if (carDTO == null)
                ...
                _applicationServiceCar.Update(carDTO);
        ...
        // DELETE api/values/5
        [HttpDelete()]
        public ActionResult Delete([FromBody] CarDTO carDTO)
        {
            try
            {
                if (carDTO == null)
                ...
                _applicationServiceCar.Remove(carDTO);
